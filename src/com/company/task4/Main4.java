...
public class Main4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Задача 3 - удаление дубликатов из коллекции   ");
    ...
    private static ArrayList<String> removeDublicates(ArrayList<String> myList) {
        int lastIdx = 0, idx = 0;
        do {
            for (String s : myList
            ) {
                idx = myList.indexOf(s);
                lastIdx = myList.lastIndexOf(s);
                if (idx != lastIdx) break;
            }
            if (idx != lastIdx) myList.remove(lastIdx);
        }
        while (idx < lastIdx);
